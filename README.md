...
```
> ℹ️ **Note:** Only the first 5 entries are shown here for brevity. The full dataset is available on [Zenodo](https://doi.org/10.5281/zenodo.17557644).
